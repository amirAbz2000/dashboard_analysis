...
4. Breaks down data into key components such as trend, seasonality, and residuals (if implemented).
5. Dynamic Filtering
6. Filter data across different time ranges, including daily, monthly, and yearly views.
